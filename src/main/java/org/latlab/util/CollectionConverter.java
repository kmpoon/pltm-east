...
public class CollectionConverter {
    /**
     * Converts a collection of {@code From} items to collection of
     * {@code To} items using the specified converter.
     * 
     * @param <From>        type of items converted from
     * @param <To>          type of items converted to
     * @param collection    original collection
     * @param converter     converts the items from {@code From} to 
     *                      {@code To} type
