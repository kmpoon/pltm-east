...
public abstract class AbstractNode {
	 ...
	 * <p>
	 * <b>Note: Only
	 * <code>DirectedAcyclicGraph.addEdge(AbstractNode, AbstractNode)</code>
	 * and <code>UndirectedGraph.addEdge(AbstractNode, AbstractNode)</code>
	...
	public void setName(String name) {
		...
		_graph.removeNodeKey(_name);

		_name = name;

		_graph.putNode(_name, this);
	}
